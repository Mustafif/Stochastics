...
# Plot the empirical autocorrelation function for Gaussian noise process
plot(sapply(0:max_lag, function(h) autocorr(X, h)), type = "h", main = "Empirical autocorrelation function for Gaussian noise process", xlab = "Lag", ylab = "Autocorrelation")
